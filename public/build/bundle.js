...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h1 = element("h1");
    			h1.textContent = "Hello pessoal!";
    			attr_dev(h1, "class", "svelte-u6o3z9");
    			add_location(h1, file$5, 22, 4, 563);
    			attr_dev(header, "class", "svelte-u6o3z9");
    			add_location(header, file$5, 21, 0, 549);
    		},
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 10, 4, 168);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	button2 = new Button({
    			props: { type: "submit", caption: "Favorite" },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1nxie9e");
    			add_location(h1, file$3, 13, 8, 244);
    			attr_dev(h2, "class", "svelte-1nxie9e");
    			add_location(h2, file$3, 14, 8, 269);
    			attr_dev(p0, "class", "svelte-1nxie9e");
    			add_location(p0, file$3, 15, 8, 297);
    			attr_dev(header, "class", "svelte-1nxie9e");
    			...
    			attr_dev(img, "class", "svelte-1nxie9e");
    			add_location(img, file$3, 18, 8, 360);
    			attr_dev(div0, "class", "image svelte-1nxie9e");
    			add_location(div0, file$3, 17, 4, 332);
    			attr_dev(p1, "class", "svelte-1nxie9e");
    			add_location(p1, file$3, 21, 8, 440);
    			attr_dev(div1, "class", "content svelte-1nxie9e");
    			add_location(div1, file$3, 20, 4, 410);
    			attr_dev(footer, "class", "svelte-1nxie9e");
    			add_location(footer, file$3, 23, 4, 476);
    			attr_dev(article, "class", "svelte-1nxie9e");
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(7:4) {#each meetups as meetup}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(section, "class", "svelte-vgynwf");
    			add_location(section, file$2, 5, 0, 99);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "svelte-2mgvsl");
    			add_location(input, file$1, 14, 8, 339);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(textarea, "class", "svelte-2mgvsl");
    			add_location(textarea, file$1, 12, 8, 271);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(label_1, "class", "svelte-2mgvsl");
    			add_location(label_1, file$1, 10, 4, 192);
    			attr_dev(div, "div", "form-control");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file, 55, 4, 1648);
    			attr_dev(main, "class", "svelte-1k5t77g");
    			add_location(main, file, 54, 0, 1637);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let meetups = [
    		{
    			...
    			description: "In this meetup, we will have some experts that could teach you how to code.",
    			imageUrl: "https://techcrunch.com/wp-content/uploads/2015/04/codecode.jpg",
    			address: "123 Blabla Street",
    			contactEmail: "marco@marco.com"
    		},
    		{
    			id: "m2",
    			title: "Swim Class",
    			subtitle: "Let's go Swim!",
    			description: "In this meetup, we will have some time swimming.",
    			imageUrl: "https://learnenglishkids.britishcouncil.org/sites/kids/files/styles/max_325x325/public/RS2503_Swimming%20col-web.jpg?itok=rya0rO9j",
    			address: "456 Blabla Street",
    			contactEmail: "marco@marco.com"
    		}
    	];
    	...
    	const input_handler_1 = event => {
    		$$invalidate(1, subtitle = event.target.value);
    	};

    	const input_handler_2 = event => {
    		$$invalidate(5, imageUrl = event.target.value);
    	};

    	const input_handler_3 = event => {
    		$$invalidate(3, email = event.target.value);
    	};

    	const input_handler_4 = event => {
    		$$invalidate(2, address = event.target.value);
    	};

    	const input_handler_5 = event => {
    		$$invalidate(4, description = event.target.value);
    	};
